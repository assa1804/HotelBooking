                    ...
                    <div className="row align-items-baseline justify-content-between">
                        ...
                        <div className="col-12 col-sm-6 col-lg-3 mt-4">
                            <div className="single-footer-widget mb-80">
                                ...
                                <div className="latest-blog-area">
                                    <a href="/blog/design-tricks" className="post-title">Freelance Design Tricks How</a>
                                    <span className="post-date"><i className="fa fa-clock-o" aria-hidden="true"></i> Jan 02, 2024</span>
                                </div>

                                <div className="latest-blog-area">
                                    <a href="/blog/advertising-tips" className="post-title">Free Advertising For Your Online</a>
                                    <span className="post-date"><i className="fa fa-clock-o" aria-hidden="true"></i> Jan 02, 2024</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-12 col-sm-8 col-lg-4">
                            <div className="single-footer-widget mb-80">
                                ...
                                <span>Subscribe our newsletter for getting notifications about new updates.</span>
                    ...
                    <div className="row align-items-center">
                        <div className="col-12 col-md-8">
                            <div className="copywrite-text">
                                <p>
                                    Copyright &copy; 2024 All rights reserved | This website is made by team 11
                                </p>
                            </div>
                        </div>
